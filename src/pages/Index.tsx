        ...
        <div className="container mx-auto px-6 md:px-12 max-w-2xl">
          <AnimatedSection>
            <div style={{ textAlign: "center" }}>
              ...
              >
                <p style={{ color: "hsl(var(--warm-dark))", fontSize: "1.05rem", lineHeight: 1.8, marginBottom: "16px" }}>
                  Чтобы прийти к тому, чего ты по-настоящему хочешь — жить в согласии с собой,<br /><br />
                  чувствовать, что ты можешь опираться на себя — когда внутри становится тише, появляется спокойная уверенность в своих решениях,<br /><br />
                  когда тебе больше не нужно постоянно сомневаться, оправдываться или подстраиваться, чтобы сохранить отношения,<br /><br />
                  когда ты перестаёшь каждый раз возвращаться в привычное «надо» и начинаешь замечать, где выбираешь не себя — и в этих моментах уже можешь действовать по-другому,<br /><br />
                  когда ты спокойно говоришь «нет» без внутреннего отката в вину и не разрушаешься от чужих реакций,<br /><br />
                  когда в отношениях появляется ты — а не только «удобная версия тебя»,<br /><br />
                  и постепенно возвращаются энергия, желания и ощущение, что ты живёшь своей жизнью, а не проживаешь её «на автомате»,<br /><br />
